        ...
        <div className={styles.divBig}>
            ...
            <div className={styles.div3}>
                ...
                <div className={styles.div3s2}>
                    ...
                    <p className={styles.sdelkatext}>Сделка формируется</p>
                </div>
            </div>
            <div className={styles.div4}>
                ...
                <div className={styles.div4s2}>
                    ...
                    <p className={styles.attentiontext2}>Продавец должен подтвердить сделку в течение 10 мин после её создания</p>
                </div>
            </div>
            <p className={styles.endtext}>Завершите создание сделки в течение 2:54</p>
            ...
            <div className={styles.div7}>
                ...
                <p>Только мошенники предлагают общение и проведение сделок вне P2P Маркета</p>
            </div>
            ...
            <Link to={"/params2"} className={styles.linkbtn}>
                <p>Создать сделку</p>
                </Link>
        </div>
    )
