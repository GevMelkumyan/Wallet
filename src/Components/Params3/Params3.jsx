...
import styles from "./Params3.module.css";
        ...
        <div className={styles.divBig}>
            ...
            <div className={styles.div3}>
                ...
                <div className={styles.div3s2}>
                    ...
                    <p className={styles.sdelkatext}>Продавец подтвердил сделку</p>
                </div>
            </div>
            <div className={styles.div4}>
                ...
                <div className={styles.div4s2}>
                    ...
                    <p className={styles.attentiontext2}>
                        Отправьте средства в течение 15 мин
                    </p>
                </div>
            </div>
            ...
            <p className={styles.p_plat}>Произведите оплату в течение 15:00</p>
            ...
            <div className={`${styles.modal} ${alert ? styles.show : styles.hide}`}>
                <div className={`${styles.div_inp}`} >
                    <p className={styles.inp_p}>Вы подтверждаете что перевели продавцу 624 545 UZS?</p>
                    <Line />
                    <div className={styles.inp_butt}>
                        <button className={styles.butt1} onClick={() => setAlert(false)}>Отмена</button>
                        <Line2 />
                        <Link className={styles.butt2} to={"/Confirmation"}>Подтвердить</Link>
                    </div>
                </div>
            </div>
