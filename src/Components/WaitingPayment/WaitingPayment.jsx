...
import style from "./WaitingPayment.module.css"
...
const WaitingPayment = () => {
    return (
        <div className={style.CreateDeal}>
            ...
            <div className={style.div_mess}>
                <div className={style.mess_icon}>
                    <MessIcon />
                </div>

                <p className={style.mess_p}>Начать чат</p>
            </div>
            ...
            <div className={style.div_chat}>
                ...
                <div className={style.chat_text}>
                    ...
                    <p className={style.p_chat}>Ожидается оплата</p>
                </div>
            </div>
            <div className={style.div_worning}>
                ...
                <div className={style.worn_name}>
                    ...
                    <p className={style.worn_p}>
                        Покупатель должен отправить 624 545 UZS в течение 15 мин
                    </p>
                </div>
            </div>
